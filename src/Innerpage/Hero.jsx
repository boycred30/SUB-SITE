...
import Logos from '../Innerpage/Logos'
  ...
  return (
   ...
   <section className="hero mt-20 flex w-[80vw] pl-[3vw] overflow-hidden">
      <motion.div variants={textVariant('.2')} className="hero-left w-[459px] h-[461px] mt-5 ml-[-4vw]">
        ...
        <h1 className='hero-head text-[80px] w-[12.2cm] h-[231px] leading-[77px] pl-[2.5vw] font-bold text-black'>Grow your subscription business</h1>
        ...
        <motion.div variants={slideIn('left', 'tween', '.5', '.3')} className="start pl-[2.5vw] mt-10 flex hero-btns">
          <motion.button 
           ...
           animate={controls}
          className="w-full text-white bg-gradient-to-r from-yellow-600 to-yellow-900 rounded-md py-3 md:py-4 text-center flex items-center justify-center"
                  >
